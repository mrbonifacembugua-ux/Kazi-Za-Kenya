...
export default function LoginPage(){
 ...
 return <main className="page"><div className="stage"><img src={BG} alt="" className="bg"/>
  ...
  <div className="icon emailIcon"/><div className="icon lockIcon"/><div className="icon eyeIcon"/>
  <div className="buttonText loginText">Log in&nbsp;&nbsp; →</div><div className="orText">or</div>
  <div className="createGroup"><span className="personIcon"/><span>Create new account</span></div>
 ...
 *{box-sizing:border-box}html,body{margin:0;width:100%;height:100%;background:#fff}body{overflow:hidden}.page,.stage{width:100vw;height:100vh;background:#fff;overflow:hidden}.stage{position:relative}
 ...
 .createGroup{left:50%;top:87.9%;transform:translate(-50%,-50%);display:flex;align-items:center;gap:10px;color:#07823f;font-size:clamp(13px,1.2vw,18px);font-weight:600}.personIcon{position:relative;width:18px;height:12px;border:2px solid #07823f;border-radius:10px 10px 3px 3px;display:inline-block}.personIcon:before{content:"";position:absolute;width:8px;height:8px;border:2px solid #07823f;border-radius:50%;left:50%;top:-11px;transform:translateX(-50%);background:#fff}.backText{left:50%;top:94.35%;transform:translate(-50%,-50%);color:#d9090d;font-size:clamp(11px,1vw,15px);font-weight:600}
 .icon{position:absolute;z-index:3;pointer-events:none}.emailIcon{left:30.7%;top:45.05%;width:1.55%;height:2.7%;border:2.2px solid #444;border-radius:2px}.emailIcon:before,.emailIcon:after{content:"";position:absolute;top:38%;width:58%;height:2px;background:#444}.emailIcon:before{left:1%;transform:rotate(32deg);transform-origin:left}.emailIcon:after{right:1%;transform:rotate(-32deg);transform-origin:right}
 .lockIcon{left:30.78%;top:58.7%;width:1.25%;height:2.7%;border:2.1px solid #444;border-radius:2px}.lockIcon:before{content:"";position:absolute;left:14%;top:-62%;width:72%;height:70%;border:2.1px solid #444;border-bottom:0;border-radius:10px 10px 0 0}.lockIcon:after{content:"";position:absolute;left:46%;top:34%;width:2px;height:6px;background:#444}.eyeIcon{left:67.55%;top:58.9%;width:1.85%;height:2.25%;border:2.1px solid #444;border-radius:50%/60%}.eyeIcon:before{content:"";position:absolute;left:50%;top:50%;width:23%;height:36%;transform:translate(-50%,-50%);border:2px solid #444;border-radius:50%}
 ...
 .remember{position:absolute;left:29.7%;top:66.1%;width:14.6%;height:4.45%;display:flex;align-items:center;cursor:pointer;font:500 clamp(10px,.94vw,14px) Inter,system-ui,"Segoe UI",Arial,sans-serif}.remember input{position:absolute;opacity:0}.checkbox{width:14%;height:55%;border:2px solid #444;border-radius:2px;background:#fff;display:flex;align-items:center;justify-content:center;color:#07823f;font-weight:700}.checkbox.checked{border-color:#07823f}.rememberText{margin-left:6%;white-space:nowrap}.forgot{left:58.6%;top:66.2%;width:13.6%;height:4.35%;color:#d9090d;font:500 clamp(10px,.94vw,14px) Inter,system-ui,"Segoe UI",Arial,sans-serif;background:#fff}.login{left:29.8%;top:71.96%;width:41.4%;height:7.09%}.create{left:29.8%;top:84.58%;width:41.4%;height:7.09%}.back{left:38%;top:92.3%;width:24%;height:4.8%}
 `}</style></main>
}
